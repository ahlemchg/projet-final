        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-5 md:gap-8">
          <div className="flex items-center gap-3 md:gap-5">
            <div className="flex items-baseline gap-1 md:gap-1.5">
              <span className="text-2xl md:text-3xl font-bold text-[#004a99]">
                0
              </span>
              <span className="text-[10px] md:text-[12px] font-bold text-gray-800">
                Days
              </span>
            </div>
            <div className="flex items-baseline gap-1 md:gap-1.5">
          ...
          <div className="flex border border-gray-200 rounded-sm overflow-hidden bg-white">
            <button className="hot-prev w-8 h-8 flex items-center justify-center hover:bg-gray-50 transition-all duration-300 border-r border-gray-200">
              <BiChevronLeft size={20} />
            </button>
            <button className="hot-next w-8 h-8 bg-black text-white flex items-center justify-center hover:bg-gray-800 transition-all duration-300">
